   	...
   	<div class="contents">
        ...
        <div class="reivewDetail-header">
            <div class="reivewDetail-img">
                <div class="img-wrap">
                    <img class="imgUrl" src="${review.img}" alt="poster">
                </div>
            </div>
            <table class="info-table">
            	<input type="hidden" name="bno" value='<c:out value="${review.bno}" />'>
                <tr>
                    <th>공연/행사명</th>
                    <td colspan="3">
                        <input class="form-control" name="title" 
                        	value="<c:out value="${review.title}" />" readonly>
                    </td>
                </tr>
                <tr>
                    <th>작성자</th>
                    <td>
                        <input class="form-control" name="writer" 
                        	value="<c:out value="${review.writer}" />" readonly>
                    </td>
                    <th>조회수</th>
                    <td>
                        <input class="form-control" name="viewCount" 
                        	value="<c:out value="${review.readCount}" />" readonly>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control" name="regDate" 
                        	value="<fmt:formatDate pattern="yyyy-MM-dd" value="${review.regDate}"/>" readonly>
                    </td>
                    <th>수정일</th>
                    <td>
                        <input class="form-control" name="updateDate" 
                       		 value="<fmt:formatDate pattern="yyyy-MM-dd" value="${review.updateDate}"/>" readonly>
                    </td>
                </tr>
                <tr>
                    <th colspan="4">내용</th>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		let bnoValue = '<c:out value = "${review.bno}" />';
		let replyUL = $(".chat");
